...
etb_cov_forward = @model begin
    ...
    @pre begin
        ...
        Vc = tvv * (WT / median(etb_data.WT)) * (1 + sexV*SEX) * (1+ageV*(AGE - median(etb_data.AGE))) * exp(η[2])
...
sexV = 0, sexCL = 0, sexF = 0, sexMTT = 0, sexVP1 = 0, sexQ= 0, ageV = 0, ageCL = 0, ageF = 0, ageMTT = 0, ageVP1 = 0, ageQ = 0, creatCL = 0, altCL = 0,  bilrbCL = 0, tflagCL =0,
